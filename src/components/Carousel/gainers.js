...
const gainersURL = "http://localhost:9800/allproducts/gainers";
// const gainersURL =
...
class GainersCarousel extends Component {
  constructor() {
    super();
...
export default GainersCarousel;
