...
app.get("/filterinbrand/:brandID", (req, res) => {
  let query = {};
...
//*** Products based on CATEGORY && BRAND with cost and sort***/

app.get("/filterincategory/:categoryID", (req, res) => {
  let query = {};
